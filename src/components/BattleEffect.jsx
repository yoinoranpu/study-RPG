     ...
     if (!isActive || !turns || turns.length === 0 || s.done) {
      ...
      if (s.turnTime < 30 && turn) {
        ...
        if (turn.type === "attack") {
          ...
          s.effects.push({
            ...
            color: turn.actor==="player" ? "#ffffff" : "#f87171",
            type:"shockwave",
          });
          ...
          s.effects.push({
            ...
            text:`${turn.dmg}`,
            isCrit:turn.isCrit,
            color: turn.actor==="player" ? (turn.isCrit?"#fbbf24":"#e8e0d0") : "#f87171",
            type:"number",
          });
          ...
          for (let i = 0; i < 20; i++) {
            ...
            s.effects.push({
              ...
              color:["#fbbf24","#f87171","#a78bfa","#4ade80"][i%4],
              type:"particle",
            });
          }
      ...
      s.effects.forEach(e => {
        ...
        if (e.type === "slash") {
          ...
          ctx.rotate(e.angle);
          ctx.beginPath();
          ctx.moveTo(-(e.len||16), 0);
          ctx.lineTo(e.len||16, 0);
          ctx.stroke();
          ctx.restore();
      ...
      if (s.playerHitFlash > 0) {
        ...
        g.addColorStop(0, `rgba(248,113,113,${a*0.6})`);
