...
export const MONSTER_PORTRAIT_DEFAULT = {
  ...
  // 旧値(zoom:2.2)は当時ファイル名の括弧(イノシシ(星2)胴体.png)がurl()を壊しスライムの絵で
  // 誤調整していたための不正値。バグ修正後、正しいイノシシ画像を見ながら顔に合わせ直した
  armored_boar:      { x: 51.12395170765303,  y: 65.53030303030303,   zoom: 1.3 },
  ...
  man_eater:         { x: 38.72858854766324,  y: 36.590909090909086,  zoom: 2.2 },
  ...
  // headパーツ画像を指すよう修正した影響で、胴体画像用に調整されていた旧値は合わなくなるため暫定値に戻した
  goblin_shaman:     { x: 50,                 y: 20,                  zoom: 1.3 },
